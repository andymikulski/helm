define(["require", "exports", 'core/logger'], function(require, exports, Logger) {
    ...
    (function (WaltUtils) {
        ...
        })(WaltUtils.Math || (WaltUtils.Math = {}));
        var Math = WaltUtils.Math;
        ...
        (function (CSS) {
            ...
            */
            function handleProp(prop, value) {
                if (!(prop === 'fill-mode' || prop === 'direction' || prop === 'timing-function') && (value.indexOf && value.indexOf('s') < 0 && value.indexOf('ms') < 0)) {
                    value += 'ms';
                }
        ...
        })(WaltUtils.CSS || (WaltUtils.CSS = {}));
        var CSS = WaltUtils.CSS;
    })(WaltUtils || (WaltUtils = {}));

    //
    //----
    (function (Walt) {
        var log = Logger.log, Utils = WaltUtils, supportsCss = Utils.CSS.supportsAnimations(), $body = $(document.body);
        ...
        */
        function animate(options) {
            ...
            if (options.hasOwnProperty('onBefore')) {
                options.onBefore($el);
            }
            ...
            if (!supportsCss || bodyIsBlurred) {
                ...
                if (options.hasOwnProperty('fallback')) {
                    options.fallback($el, function () {
                        return onAnimateEnd($el, options);
                    });
                } else {
                    if (!bodyIsBlurred) {
                ...
                $el.on('animationend webkitAnimationEnd oAnimationEnd MSAnimationEnd', (function (e) {
                    return onAnimateEnd($el, options);
                })).css(objectCSS).addClass('walt-animate ' + options.animation);
            }
    ...
    })(exports.Walt || (exports.Walt = {}));
    var Walt = exports.Walt;
});
